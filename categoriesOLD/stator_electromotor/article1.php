 ...
 <div class="articlePhoto">
  <div class="productArtImg">
   <div class="productArtImgSmall">
    ...
    <div class="imgart1"><img src="/img/imgstatorelectromotor/<?php echo $row131['voltag']; ?>_1.jpg" data-lightbox="<?php echo $row131['voltag']; ?>"  onerror='this.style.display = "none"' onclick="myFunction(this)" style="display: block;"></div><br>
    <div class="imgart1"><img src="/img/imgstatorelectromotor/<?php echo $row131['voltag']; ?>_2.jpg" data-lightbox="<?php echo $row131['voltag']; ?>"  onerror='this.style.display = "none"' onclick="myFunction(this)" style="display: block;"></div><br>
    <div class="imgart1"><img src="/img/imgstatorelectromotor/<?php echo $row131['voltag']; ?>_3.jpg" data-lightbox="<?php echo $row131['voltag']; ?>"  onerror='this.style.display = "none"' onclick="myFunction(this)" style="display: block;"></div><br>
    <div class="imgart1"><img src="/img/imgstatorelectromotor/<?php echo $row131['voltag']; ?>_4.jpg" data-lightbox="<?php echo $row131['voltag']; ?>"  onerror='this.style.display = "none"' onclick="myFunction(this)" style="display: block;"></div><br>
    <div class="imgart1"><img src="/img/imgstatorelectromotor/<?php echo $row131['voltag']; ?>_5.jpg" data-lightbox="<?php echo $row131['voltag']; ?>"  onerror='this.style.display = "none"' onclick="myFunction(this)" style="display: block;"></div><br>
