...
<div class="sidebaropt">
  ...
  <div class="link">
    <a href="#"><div class="sidebartext">ELECTROMOTOARE</div></a>
  </div>
  <div class="link">
...
<div class="aplicaridiod tablesArt1ProductCrossesonthesite">
 ...
 <?php
 $voltajj = '1';
 $query = "SELECT id, imgsrc, link, category, voltag, product_status FROM statorelinitial WHERE product_status = '1' ORDER BY id DESC";
 ...
 if($voltajj != NULL)
 {
  foreach($result as $rowwwee)
  {
     
   $output .= '

  <div class="hrefimgg"><a href="article1.php?id='. $rowwwee['id'] .'"><li><img class="nodatablock datanotfoundimg1" src="../../img/imgstatorelectromotor/'. $rowwwee['voltag'] .'_1.jpg" alt="0">'.$rowwwee['link'].'</li></a></div>
...
$(document).ready(function(){
  ...
  function filter_data()
  {
      ...
      $.ajax({
          url:"../../includes/products/fetch_bendix1.php",
          method:"POST",
          beforeSend: function(){
