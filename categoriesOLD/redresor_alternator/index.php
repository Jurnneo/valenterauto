...
<title>Redresor alternator în Iași, Romania.</title>
...
<div class="footerrtyInside11erCatalog">
  ...
  <a href="#"><p><img src="/img/imgSite/catalogButton1.png" class="footerrtyInside11erCatalogImg">REDRESOR ALTERNATOR</p></a>               
</div>

<div class="whyNotWork">
 <h2 class="catTest">REDRESOR ALTERNATOR<span style="display: none;">1.681 POZIȚII</span></h2>
...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  <?php
   $query = "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1, ch11_1, ch12_1, ch13_1, ch14_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Redresor alternator'";
...
<div class="CatalogGrid1FiltrationOpenTensiune CatalogGrid1Filtration">
 ...
 <?php
   $query = "SELECT DISTINCT(ch1_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch1_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch2_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch2_2 ASC"; 
   $query .= "";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch3_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch3_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch4_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch4_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch5_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch5_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch6_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch6_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch7_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch7_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch8_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch8_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch9_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch9_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 ?>           
  ...
  <div class="closeModalSearrchBss_lin_ide"></div>
   <!--<button style="width: 28px;" class="LoadFilter11ClosegridcontainerOpen LoadFilter11"><img class="closeImgFill" src="img/imgSite/closeFill.png"></button>-->
   <h4><?php echo $rowbch11['ch10_1']; ?></h4>
   <div class="gridcontainerOpenBss_lin_ide grid-container">


 <?php
   $query = "SELECT DISTINCT(ch10_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch10_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
<?php if ( $rowbss['ch10_2'] != NULL) echo
    '<div class="box">
      <div class="item">
       <div class="checkbox-circle">
        <input type="checkbox" class="common_selector ch10_2" value="'.$rowbss['ch10_2'].'" id="checkbox-circle'.$rowbss['ch10_2'].'ch10_2" name="check">
        <label for="checkbox-circle'.$rowbss['ch10_2'].'ch10_2">'.$rowbss['ch10_2'].'</label>
       </div>
      </div>
     </div>'
?>  
 ...
 ?>           
    ...
    <div class="CatalogGrid1FiltrationOpenBss_lin_idech11 CatalogGrid1Filtration">
  <div class="openModalSearrchBss_lin_idech11"></div>
  <div class="closeModalSearrchBss_lin_idech11"></div>
   <!--<button style="width: 28px;" class="LoadFilter11ClosegridcontainerOpen LoadFilter11"><img class="closeImgFill" src="img/imgSite/closeFill.png"></button>-->
   <h4><?php echo $rowbch11['ch11_1']; ?></h4>
   <div class="gridcontainerOpenBss_lin_idech11 grid-container">


 <?php
   $query = "SELECT DISTINCT(ch11_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch11_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
<?php if ( $rowbss['ch11_2'] != NULL) echo
    '<div class="box">
      <div class="item">
       <div class="checkbox-circle">
        <input type="checkbox" class="common_selector ch11_2" value="'.$rowbss['ch11_2'].'" id="checkbox-circle'.$rowbss['ch11_2'].'ch11_2" name="check">
        <label for="checkbox-circle'.$rowbss['ch11_2'].'ch11_2">'.$rowbss['ch11_2'].'</label>
       </div>
      </div>
     </div>'
?>  
 ...
 ?>           
    ...
    <div class="CatalogGrid1FiltrationOpenBss_lin_idech12 CatalogGrid1Filtration">
  <div class="openModalSearrchBss_lin_idech12"></div>
  <div class="closeModalSearrchBss_lin_idech12"></div>
   <!--<button style="width: 28px;" class="LoadFilter11ClosegridcontainerOpen LoadFilter11"><img class="closeImgFill" src="img/imgSite/closeFill.png"></button>-->
   <h4><?php echo $rowbch11['ch12_1']; ?></h4>
   <div class="gridcontainerOpenBss_lin_idech12 grid-container">


 <?php
   $query = "SELECT DISTINCT(ch12_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch12_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
<?php if ( $rowbss['ch12_2'] != NULL) echo
    '<div class="box">
      <div class="item">
       <div class="checkbox-circle">
        <input type="checkbox" class="common_selector ch12_2" value="'.$rowbss['ch12_2'].'" id="checkbox-circle'.$rowbss['ch12_2'].'ch12_2" name="check">
        <label for="checkbox-circle'.$rowbss['ch12_2'].'ch12_2">'.$rowbss['ch12_2'].'</label>
       </div>
      </div>
     </div>'
?>  
 ...
 ?>           
    ...
    <div class="CatalogGrid1FiltrationOpenBss_lin_idech13 CatalogGrid1Filtration">
  <div class="openModalSearrchBss_lin_idech13"></div>
  <div class="closeModalSearrchBss_lin_idech13"></div>
   <!--<button style="width: 28px;" class="LoadFilter11ClosegridcontainerOpen LoadFilter11"><img class="closeImgFill" src="img/imgSite/closeFill.png"></button>-->
   <h4><?php echo $rowbch11['ch13_1']; ?></h4>
   <div class="gridcontainerOpenBss_lin_idech13 grid-container">


 <?php
   $query = "SELECT DISTINCT(ch13_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch13_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
<?php if ( $rowbss['ch13_2'] != NULL) echo
    '<div class="box">
      <div class="item">
       <div class="checkbox-circle">
        <input type="checkbox" class="common_selector ch13_2" value="'.$rowbss['ch13_2'].'" id="checkbox-circle'.$rowbss['ch13_2'].'ch13_2" name="check">
        <label for="checkbox-circle'.$rowbss['ch13_2'].'ch13_2">'.$rowbss['ch13_2'].'</label>
       </div>
      </div>
     </div>'
?>  
 ...
 ?>           
    ...
    <div class="CatalogGrid1FiltrationOpenBss_lin_idech14 CatalogGrid1Filtration">
  <div class="openModalSearrchBss_lin_idech14"></div>
  <div class="closeModalSearrchBss_lin_idech14"></div>
   <!--<button style="width: 28px;" class="LoadFilter11ClosegridcontainerOpen LoadFilter11"><img class="closeImgFill" src="img/imgSite/closeFill.png"></button>-->
   <h4><?php echo $rowbch11['ch14_1']; ?></h4>
   <div class="gridcontainerOpenBss_lin_idech14 grid-container">


 <?php
   $query = "SELECT DISTINCT(ch14_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE categoryinfilter = 'Redresor alternator' ORDER BY ch14_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
<?php if ( $rowbss['ch14_2'] != NULL) echo
    '<div class="box">
      <div class="item">
       <div class="checkbox-circle">
        <input type="checkbox" class="common_selector ch14_2" value="'.$rowbss['ch14_2'].'" id="checkbox-circle'.$rowbss['ch14_2'].'ch14_2" name="check">
        <label for="checkbox-circle'.$rowbss['ch14_2'].'ch14_2">'.$rowbss['ch14_2'].'</label>
       </div>
      </div>
     </div>'
?>  
...
$(document).ready(function(){
  ...
  function filter_data()
  {
      ...
      $.ajax({
          url:"../../includes/products/fetch_datadiodmost.php",
          method:"POST",
          beforeSend: function(){
