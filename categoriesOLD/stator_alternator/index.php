...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  <?php
   $query = "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1, ch11_1, ch12_1, ch13_1, ch14_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Stator alternator'";
...
<div class="CatalogGrid1FiltrationOpenTensiune CatalogGrid1Filtration">
 ...
 <?php
   $query = "SELECT DISTINCT(ch1_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE categoryinfilter = 'Stator alternator' ORDER BY ch1_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch2_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE categoryinfilter = 'Stator alternator' ORDER BY ch2_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch3_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE categoryinfilter = 'Stator alternator' ORDER BY ch3_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch4_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE categoryinfilter = 'Stator alternator' ORDER BY ch4_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
<?php if ( $rowbss['ch4_2'] != NULL) echo
    '<div class="box">
      <div class="item">
       <div class="checkbox-circle">
        <input type="checkbox" class="common_selector ch4_2" value="'.$rowbss['ch4_2'].'" id="checkbox-circle'.$rowbss['ch4_2'].'ch4_2" name="check">
        <label for="checkbox-circle'.$rowbss['ch4_2'].'ch4_2">'.$rowbss['ch4_2'].'</label>
       </div>
      </div>
     </div>'
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch5_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE categoryinfilter = 'Stator alternator' ORDER BY ch5_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch6_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE categoryinfilter = 'Stator alternator' ORDER BY ch6_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch7_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE categoryinfilter = 'Stator alternator' ORDER BY ch7_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
$(document).ready(function(){
  ...
  function filter_data()
  {
      ...
      $.ajax({
          url:"../../includes/products/fetch_stator.php",
          method:"POST",
          beforeSend: function(){
