...
<div class="aplicaridiod tablesArt1ProductCrossesonthesite">
 ...
 <?php
 $voltajj = '1';
 $query = "SELECT id, imgsrc, link, category, voltag, product_status FROM regulatorinitial WHERE product_status = '1' ORDER BY id DESC";
 ...
 if($voltajj != NULL)
 {
  ...
  <div class="hrefimgg"><a href="article1.php?id='. $rowwwee['id'] .'"><li><img class="nodatablock datanotfoundimg1" src="../../img/imgregulatoar/'. $rowwwee['voltag'] .'_1.jpg" alt="0">'.$rowwwee['link'].'</li></a></div>
