...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  <?php
   $query = "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1, ch11_1, ch12_1, ch13_1, ch14_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Fulie cu ambreiaj'";
...
<div class="CatalogGrid1FiltrationOpenTensiune CatalogGrid1Filtration">
 ...
 <?php
   $query = "SELECT DISTINCT(ch1_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch1_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch2_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch2_2 ASC"; 
   $query .= "";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch3_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch3_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch4_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch4_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch5_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch5_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch6_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch6_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch7_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch7_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
?>  
 ...
 <?php
   $query = "SELECT DISTINCT(ch8_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch8_2 ASC";
   $statement = $connect->prepare($query);
   $statement->execute();
   $result = $statement->fetchAll();
   foreach ($result as $rowbss) {
...
$(document).ready(function(){
  ...
  function filter_data()
  {
      ...
      $.ajax({
          url:"../../includes/products/fetch_fulie.php",
          method:"POST",
          beforeSend: function(){
