...
<div class="wow fadeIn searchGallDivv galleryDiv mobileGallDivv">
    ...
    $query = "SELECT inelinitial.id, inelinitial.imgsrc, inelinitial.link, inelinitial.autovalenter, inelinitial.psh, inelinitial.wood, inelinitial.waiglobal, inelinitial.category, inelinitial.voltag, inelkrosstablefilter.ch1_2, inelkrosstablefilter.ch2_2, inelkrosstablefilter.ch3_2, inelkrosstablefilter.ch4_2, inelkrosstablefilter.ch5_2, inelkrosstablefilter.ch6_2, inelkrosstablefilter.ch8_2, inelkrosstablefilter.ch9_2, inelkrosstablefilter.ch10_2, inelkrosstablefilter.ch7_2, inelkrosstablefilter.ch11_2, inelkrosstablefilter.ch12_2, inelkrosstablefilter.ch13_2, inelkrosstablefilter.ch14_2, inelkrosstablefilter.ch1, inelkrosstablefilter.ch2, inelkrosstablefilter.ch3, inelkrosstablefilter.ch4, inelkrosstablefilter.ch5, inelkrosstablefilter.ch6, inelkrosstablefilter.ch8, inelkrosstablefilter.ch9, inelkrosstablefilter.ch10, inelkrosstablefilter.ch7, inelkrosstable.linkalternator, inelkrosstable.mitsubishi, inelkrosstable.bosch, inelkrosstable.delco, inelkrosstable.renault, inelkrosstable.mercedesbenz, inelkrosstable.ford, inelkrosstablefilter.ch11, inelkrosstablefilter.ch12, inelkrosstablefilter.ch13, inelkrosstablefilter.ch14,inelkrosstable.valeo, inelkrosstable.ass1, inelkrosstable.cas, inelkrosstable.hyundai, inelkrosstable.cargo, inelkrosstable.kia, inelkrosstable.krauf, inelkrosstable.mando, inelkrosstable.messmer, inelkrosstable.motorherz, inelkrosstable.zaufer, inelkrosstable.wai, inelkrosstable.hc_parts, inelkrosstable.hella, inelkrosstable.lucas, inelkrosstable.magnetimarelli, inelkrosstable.wps, inelkrosstable.bcc, inelkrosstable.prestolite, inelkrosstable.volvo, inelkrosstable.yam, inelkrosstable.hbb, inelkrosstable.mazda, inelkrosstable.daewoo, inelkrosstable.gmm, inelkrosstable.maz, inelkrosstable.pmx, inelkrosstable.unipoint, inelkrosstable.citroen, inelkrosstable.nissan, inelkrosstable.reparts, inelkrosstable.bll, inelkrosstable.acdelco, inelkrosstable.generalmotors, inelkrosstable.brillance, inelkrosstable.komatsu, inelkrosstable.nikko, inelkrosstable.wll, inelkrosstable.vag, inelkrosstable.hino, inelkrosstable.sawafuji, inelkrosstable.poong_sung, inelkrosstable.motorola, inelkrosstable.cat, inelkrosstable.hyster, inelkrosstable.skk, inelkrosstable.pee, inelkrosstable.magneton, inelkrosstable.case, inelkrosstable.deutz, inelkrosstable.mahle, inelkrosstable.khd, inelkrosstable.iskra, inelkrosstable.hitachi, inelkrosstable.john_deere, inelkrosstable.vww, inelkrosstable.denso, inelkrosstable.general_motors, inelkrosstable.opel FROM `inelinitial` INNER JOIN `inelkrosstable` ON inelinitial.voltag = inelkrosstable.linkalternator INNER JOIN `inelkrosstablefilter` ON inelkrosstablefilter.linkalternator = inelkrosstable.linkalternator WHERE product_status = '1' AND (inelkrosstable.linkalternator LIKE '%".$search."%'    
      OR inelinitial.autovalenter LIKE '%".$search."%'
      OR inelinitial.link LIKE '%".$search."%'
      OR inelinitial.psh LIKE '%".$search."%'
      OR inelinitial.wood LIKE '%".$search."%'
      OR inelinitial.waiglobal LIKE '%".$search."%'
      OR inelkrosstable.bosch LIKE '%".$search."%'
      OR inelkrosstable.mitsubishi LIKE '%".$search."%'
      OR inelkrosstable.delco LIKE '%".$search."%'
      OR inelkrosstable.renault LIKE '%".$search."%'
      OR inelkrosstable.mercedesbenz LIKE '%".$search."%'
      OR inelkrosstable.ford LIKE '%".$search."%'
      OR inelkrosstable.valeo LIKE '%".$search."%'
      OR inelkrosstable.ass1 LIKE '%".$search."%'
      OR inelkrosstable.cas LIKE '%".$search."%'
      OR inelkrosstable.hyundai LIKE '%".$search."%'
      OR inelkrosstable.kia LIKE '%".$search."%'
      OR inelkrosstable.krauf LIKE '%".$search."%'
      OR inelkrosstable.mando LIKE '%".$search."%'
      OR inelkrosstable.messmer LIKE '%".$search."%'
      OR inelkrosstable.motorherz LIKE '%".$search."%'
      OR inelkrosstable.zaufer LIKE '%".$search."%'
      OR inelkrosstable.wai LIKE '%".$search."%'
      OR inelkrosstable.hc_parts LIKE '%".$search."%'
      OR inelkrosstable.hella LIKE '%".$search."%'
      OR inelkrosstable.lucas LIKE '%".$search."%'
      OR inelkrosstable.magnetimarelli LIKE '%".$search."%'
      OR inelkrosstable.wps LIKE '%".$search."%'
      OR inelkrosstable.bcc LIKE '%".$search."%'
      OR inelkrosstable.prestolite LIKE '%".$search."%'
      OR inelkrosstable.volvo LIKE '%".$search."%'
      OR inelkrosstable.yam LIKE '%".$search."%'
      OR inelkrosstable.hbb LIKE '%".$search."%'
      OR inelkrosstable.mazda LIKE '%".$search."%'
      OR inelkrosstable.daewoo LIKE '%".$search."%'
      OR inelkrosstable.gmm LIKE '%".$search."%'
      OR inelkrosstable.maz LIKE '%".$search."%'
      OR inelkrosstable.pmx LIKE '%".$search."%'
      OR inelkrosstable.unipoint LIKE '%".$search."%'
      OR inelkrosstable.citroen LIKE '%".$search."%'
      OR inelkrosstable.reparts LIKE '%".$search."%'
      OR inelkrosstable.bll LIKE '%".$search."%'
      OR inelkrosstable.acdelco LIKE '%".$search."%'
      OR inelkrosstable.generalmotors LIKE '%".$search."%'
      OR inelkrosstable.brillance LIKE '%".$search."%'
      OR inelkrosstable.komatsu LIKE '%".$search."%'
      OR inelkrosstable.nikko LIKE '%".$search."%'
      OR inelkrosstable.wll LIKE '%".$search."%'
      OR inelkrosstable.vag LIKE '%".$search."%'
      OR inelkrosstable.hino LIKE '%".$search."%'
      OR inelkrosstable.sawafuji LIKE '%".$search."%'
      OR inelkrosstable.poong_sung LIKE '%".$search."%'
      OR inelkrosstable.motorola LIKE '%".$search."%'
      OR inelkrosstable.cat LIKE '%".$search."%'
      OR inelkrosstable.hyster LIKE '%".$search."%'
      OR inelkrosstable.skk LIKE '%".$search."%'
      OR inelkrosstable.pee LIKE '%".$search."%'
      OR inelkrosstable.magneton LIKE '%".$search."%'
      OR inelkrosstable.case LIKE '%".$search."%'
      OR inelkrosstable.deutz LIKE '%".$search."%'
      OR inelkrosstable.mahle LIKE '%".$search."%'
      OR inelkrosstable.khd LIKE '%".$search."%'
      OR inelkrosstable.iskra LIKE '%".$search."%'
      OR inelkrosstable.hitachi LIKE '%".$search."%'
      OR inelkrosstable.john_deere LIKE '%".$search."%'
      OR inelkrosstable.vww LIKE '%".$search."%'
      OR inelkrosstable.denso LIKE '%".$search."%'
      OR inelkrosstable.general_motors LIKE '%".$search."%'
      OR inelkrosstable.opel LIKE '%".$search."%'
      OR inelkrosstable.nissan LIKE '%".$search."%'
      OR inelkrosstable.cargo LIKE '%".$search."%')
      ORDER BY id DESC";
     ...
     <a href="categories/'.$categoryreplaced.'/article.php?id='. $row['id'] .'" target="_blank">
        <div class="galleryDivvImg">
            <img style="width: 100%" class="galleryDivvImgBckgroundImg" src="../../img/imgSite/backgroundImgPng.png">
             ...
             <img src="/img/imginelalternator/'.$row["voltag"].'_1.jpg" width="100%">
             </div>
