...
if(isset($_POST["action"]))
{
 ...
 $query = "
  SELECT inelinitial.id, inelinitial.link, inelinitial.imgsrc, inelinitial.title, inelinitial.price, inelinitial.category, inelinitial.product_status, inelinitial.voltag, inelkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, inelkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, inelkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, inelkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, inelkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, inelkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, inelkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, inelkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, inelkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, inelkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, inelkrosstablefilter.ch10_2 FROM inelinitial
    ...
    WHERE category = 'Inel collector' AND product_status = '1'
 ";
