...
if(isset($_POST["action"]))
{
 ...
 $query = "
  SELECT statoraltinitial.id, statoraltinitial.link, statoraltinitial.imgsrc, statoraltinitial.title, statoraltinitial.price, statoraltinitial.category, statoraltinitial.product_status, statoraltinitial.voltag, statoraltkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, statoraltkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, statoraltkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, statoraltkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, statoraltkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, statoraltkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, statoraltkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, statoraltkrosstablefilter.ch7_2 FROM statoraltinitial
    ...
    WHERE category = 'Stator alternator' AND product_status = '1'
 ";
...
$query .= " LIMIT " . $_POST["limit"] . " OFFSET " . $_POST["offset"];
 ...
 {
  if ($_POST["offset"] == 0) {
    $output = '<img class="nodatablocknoneblock nodatablock datanotfoundimg1" src="../../img/imgSite/notfound2png.png" alt="DATA NOT FOUND"><img class="nodatanone datanotfoundimg1" src="../../img/imgSite/notfound21png.png" alt="DATA NOT FOUND">';
  } else {
    $output = '';
  }
 }
