...
if(isset($_POST["action"]))
{
 ...
 $query = "
  SELECT redresorinitial.id, redresorinitial.link, redresorinitial.imgsrc, redresorinitial.title, redresorinitial.price, redresorinitial.category, redresorinitial.product_status, redresorinitial.voltag, redresorkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, redresorkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, redresorkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, redresorkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, redresorkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, redresorkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, redresorkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, redresorkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, redresorkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, redresorkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, redresorkrosstablefilter.ch10_2, krosstablefilter_categories.ch11, redresorkrosstablefilter.ch11_2, krosstablefilter_categories.ch12, redresorkrosstablefilter.ch12_2, krosstablefilter_categories.ch13, redresorkrosstablefilter.ch13_2, krosstablefilter_categories.ch14, redresorkrosstablefilter.ch14_2 FROM redresorinitial
    ...
    WHERE category = 'Redresor alternator' AND product_status = '1'
 ";

   if(isset($_POST["ch14_2"]))
 {
  $ch14_2 = implode("|", $_POST["ch14_2"]);
  $query .= "
   AND ch14_2 REGEXP '" .$ch14_2. "'
  ";
 }

   if(isset($_POST["ch13_2"]))
 {
  $ch13_2 = implode("|", $_POST["ch13_2"]);
  $query .= "
   AND ch13_2 REGEXP '" .$ch13_2. "'
  ";
 }
...
$query .= " LIMIT " . $_POST["limit"] . " OFFSET " . $_POST["offset"];
 ...
 $query = "SELECT SUM(Column_4) AS Column_5sum FROM `redresorstock` WHERE `Column_3` = '$titleupakovka' AND (`Column_2` = '$linksklad5' OR `Column_1` = '$linksklad5')";
