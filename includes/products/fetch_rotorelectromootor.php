...
if(isset($_POST["action"]))
{
 ...
 $query = "
  SELECT rotorelinitial.id, rotorelinitial.link, rotorelinitial.imgsrc, rotorelinitial.title, rotorelinitial.price, rotorelinitial.category, rotorelinitial.product_status, rotorelinitial.voltag, rotorelkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, rotorelkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, rotorelkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, rotorelkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, rotorelkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, rotorelkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, rotorelkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, rotorelkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, rotorelkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, rotorelkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, rotorelkrosstablefilter.ch10_2 FROM rotorelinitial
    ...
    WHERE category = 'Rotor electromotor' AND product_status = '1'
 ";
