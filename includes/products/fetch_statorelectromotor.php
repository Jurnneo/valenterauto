...
if(isset($_POST["action"]))
{
 ...
 $query = "
  SELECT statorelinitial.id, statorelinitial.link, statorelinitial.imgsrc, statorelinitial.title, statorelinitial.price, statorelinitial.category, statorelinitial.product_status, statorelinitial.voltag, statorelkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, statorelkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, statorelkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, statorelkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, statorelkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, statorelkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, statorelkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, statorelkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, statorelkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, statorelkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, statorelkrosstablefilter.ch10_2 FROM statorelinitial
    ...
    WHERE category = 'Stator electromotor' AND product_status = '1'
 ";
