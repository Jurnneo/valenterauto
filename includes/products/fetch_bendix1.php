...
if(isset($_POST["action"]))
{
 ...
 $query = "
  SELECT alternators.id, alternators.link, alternators.imgsrc, alternators.price, alternators.category, alternators.product_status, alternators.voltag FROM alternators WHERE category = 'Regulator alternator' AND product_status = '1'
 ";
  ...
  foreach($result as $row)
  {
   ...
   $output .= '
    ...
    <div class="galleryDivvSearch galleryDivv">
      <a href="article1.php?id='. $row['id'] .'" target="_blank">
