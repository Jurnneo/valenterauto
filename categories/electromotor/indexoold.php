...
<div class="whyNotWorkDropdown whyNotWork">
  ...
  <div class="dropdown">
    ...
    <div class="options">
      <a href="index.php?sort=id-asc"><div onclick="show(' ADAUGARE (CRESCATOR) ')"> ADAUGARE (CRESCATOR) </div></a>
      <a href="index.php?sort=id-desc"><div onclick="show(' ADAUGARE (DESCRESCATOR) ')"> ADAUGARE (DESCRESCATOR) </div></a>
      <a href="index.php?sort=link-asc"><div onclick="show(' ALFABETIC (A - Z) ')"> ALFABETIC (A - Z) </div></a>
      <a href="index.php?sort=link-desc"><div onclick="show(' ALFABETIC (Z - A) ')"> ALFABETIC (Z - A) </div></a>
    </div>
  </div>
</div>
...
<div class="CatalogGrid2">
 <div class="contentCatalog">
  ...
  $result = mysqli_query($link, "SELECT electromotorinitial.id, electromotorinitial.link, electromotorinitial.title, electromotorinitial.imgsrc, electromotorinitial.price, electromotorinitial.category, electromotorinitial.product_status, electromotorinitial.voltag, electromotorkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, electromotorkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, electromotorkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, electromotorkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, electromotorkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, electromotorkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, electromotorkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, electromotorkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, electromotorkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, electromotorkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, electromotorkrosstablefilter.ch10_2 FROM electromotorinitial
    ...
    WHERE category = 'Electromotor' AND product_status = '1' ORDER BY $sorting $sorting1");
