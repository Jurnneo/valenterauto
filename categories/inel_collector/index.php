...
<title>Inel collector în Iași, Romania.</title>
...
<div class="footerrtyInside11erCatalog">
  ...
  <a href="#"><p><img src="/img/imgSite/catalogButton1.png" class="footerrtyInside11erCatalogImg">INEL COLLECTOR</p></a>               
</div>

<div class="whyNotWork">
 <h2 class="catTest">INEL COLLECTOR <span style="display: none;">1.681 POZIȚII</span></h2>
...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  $result = mysqli_query($link, "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Inel collector'");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM inelinitial ORDER BY brend ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM inelinitial WHERE NOT brend = '' ORDER BY brend ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM inelinitial INNER JOIN inelkrosstablefilter ON inelinitial.voltag = inelkrosstablefilter.linkalternator WHERE NOT brend = '' AND categoryinfilter = 'Inel collector' ORDER BY ch1_2 ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM inelinitial INNER JOIN inelkrosstablefilter ON inelinitial.voltag = inelkrosstablefilter.linkalternator WHERE NOT ch1_2 = '' AND categoryinfilter = 'Inel collector' ORDER BY ch1_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch2_2) FROM inelinitial INNER JOIN inelkrosstablefilter ON inelinitial.voltag = inelkrosstablefilter.linkalternator WHERE NOT ch2_2 = '' AND categoryinfilter = 'Inel collector' ORDER BY ch2_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch3_2) FROM inelinitial INNER JOIN inelkrosstablefilter ON inelinitial.voltag = inelkrosstablefilter.linkalternator WHERE NOT ch3_2 = '' AND categoryinfilter = 'Inel collector' ORDER BY ch3_2 ASC");
...
<div class="CatalogGrid2">
 <div class="contentCatalog">
  <div id="myULssh" class="row filter_data" >
    ...
    $count = mysqli_query($link, "SELECT inelinitial.id, inelinitial.link, inelinitial.brend, inelinitial.title, inelinitial.imgsrc, inelinitial.price, inelinitial.category, inelinitial.product_status, inelinitial.voltag, inelkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, inelkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, inelkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, inelkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, inelkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, inelkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, inelkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, inelkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, inelkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, inelkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, inelkrosstablefilter.ch10_2 FROM inelinitial
    LEFT JOIN inelkrosstablefilter
    ON inelinitial.voltag = inelkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON inelkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
  ...
  $result = mysqli_query($link, "SELECT inelinitial.id, inelinitial.link, inelinitial.brend, inelinitial.title, inelinitial.imgsrc, inelinitial.price, inelinitial.category, inelinitial.product_status, inelinitial.voltag, inelkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, inelkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, inelkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, inelkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, inelkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, inelkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, inelkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, inelkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, inelkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, inelkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, inelkrosstablefilter.ch10_2 FROM inelinitial
    LEFT JOIN inelkrosstablefilter
    ON inelinitial.voltag = inelkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON inelkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
    WHERE product_status = '1' $query_ch1_2 $query_ch1_3 $query_ch1_4 $query_ch1_5 $query_ch1_6 $query_ch1_7 $query_ch1_8 $query_ch1_9 $query_ch1_10 $query_ch1_11 $query_ch1_12 ORDER BY id DESC $query_start_num");
 ...
 $result1 = mysqli_query($link, "SELECT SUM(Column_4) AS Column_5sum FROM `inelstock` WHERE `Column_3` = '$titleupakovka' AND (`Column_2` = '$linksklad5' OR `Column_1` = '$linksklad5')");
