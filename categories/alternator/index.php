...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  $result = mysqli_query($link, "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Alternator'");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM alternatorinitial ORDER BY brend ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM alternatorinitial WHERE NOT brend = '' ORDER BY brend ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT brend = '' AND categoryinfilter = 'Alternator' ORDER BY ch1_2 ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch1_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch1_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch2_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch2_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch2_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch3_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch3_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch3_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch4_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch4_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch4_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch5_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch5_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch5_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch6_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch6_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch6_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch7_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch7_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch7_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch8_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch8_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch8_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch9_2) FROM alternatorinitial INNER JOIN alternatorkrosstablefilter ON alternatorinitial.voltag = alternatorkrosstablefilter.linkalternator WHERE NOT ch9_2 = '' AND categoryinfilter = 'Alternator' ORDER BY ch9_2 ASC");
