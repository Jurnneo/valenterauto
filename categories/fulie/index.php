...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  $result = mysqli_query($link, "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Fulie'");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM fulieinitial ORDER BY brend ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM fulieinitial WHERE NOT brend = '' ORDER BY brend ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM fulieinitial INNER JOIN fuliekrosstablefilter ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator WHERE NOT brend = '' AND categoryinfilter = 'Fulie' ORDER BY ch1_2 ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM fulieinitial INNER JOIN fuliekrosstablefilter ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator WHERE NOT ch1_2 = '' AND categoryinfilter = 'Fulie' ORDER BY ch1_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch2_2) FROM fulieinitial INNER JOIN fuliekrosstablefilter ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator WHERE NOT ch2_2 = '' AND categoryinfilter = 'Fulie' ORDER BY ch2_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch3_2) FROM fulieinitial INNER JOIN fuliekrosstablefilter ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator WHERE NOT ch3_2 = '' AND categoryinfilter = 'Fulie' ORDER BY ch3_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch4_2) FROM fulieinitial INNER JOIN fuliekrosstablefilter ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator WHERE NOT ch4_2 = '' AND categoryinfilter = 'Fulie' ORDER BY ch4_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch5_2) FROM fulieinitial INNER JOIN fuliekrosstablefilter ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator WHERE NOT ch5_2 = '' AND categoryinfilter = 'Fulie' ORDER BY ch5_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch6_2) FROM fulieinitial INNER JOIN fuliekrosstablefilter ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator WHERE NOT ch6_2 = '' AND categoryinfilter = 'Fulie' ORDER BY ch6_2 ASC");
...
<div class="CatalogGrid2">
 <div class="contentCatalog">
  <div id="myULssh" class="row filter_data" >
    ...
    $count = mysqli_query($link, "SELECT fulieinitial.id, fulieinitial.link, fulieinitial.brend, fulieinitial.title, fulieinitial.imgsrc, fulieinitial.price, fulieinitial.category, fulieinitial.product_status, fulieinitial.voltag, fuliekrosstablefilter.linkalternator, krosstablefilter_categories.ch1, fuliekrosstablefilter.ch1_2, krosstablefilter_categories.ch2, fuliekrosstablefilter.ch2_2, krosstablefilter_categories.ch3, fuliekrosstablefilter.ch3_2, krosstablefilter_categories.ch4, fuliekrosstablefilter.ch4_2, krosstablefilter_categories.ch5, fuliekrosstablefilter.ch5_2, krosstablefilter_categories.ch6, fuliekrosstablefilter.ch6_2 FROM fulieinitial
    LEFT JOIN fuliekrosstablefilter
    ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON fuliekrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
  ...
  $result = mysqli_query($link, "SELECT fulieinitial.id, fulieinitial.link, fulieinitial.brend, fulieinitial.title, fulieinitial.imgsrc, fulieinitial.price, fulieinitial.category, fulieinitial.product_status, fulieinitial.voltag, fuliekrosstablefilter.linkalternator, krosstablefilter_categories.ch1, fuliekrosstablefilter.ch1_2, krosstablefilter_categories.ch2, fuliekrosstablefilter.ch2_2, krosstablefilter_categories.ch3, fuliekrosstablefilter.ch3_2, krosstablefilter_categories.ch4, fuliekrosstablefilter.ch4_2, krosstablefilter_categories.ch5, fuliekrosstablefilter.ch5_2, krosstablefilter_categories.ch6, fuliekrosstablefilter.ch6_2 FROM fulieinitial
    LEFT JOIN fuliekrosstablefilter
    ON fulieinitial.voltag = fuliekrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON fuliekrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
    WHERE product_status = '1' $query_ch1_2 $query_ch1_3 $query_ch1_4 $query_ch1_5 $query_ch1_6 $query_ch1_7 $query_ch1_8 $query_ch1_9 $query_ch1_10 $query_ch1_11 $query_ch1_12 ORDER BY id DESC $query_start_num");
