...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  $result = mysqli_query($link, "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Redresor alternator'");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM redresorinitial ORDER BY brend ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM redresorinitial WHERE NOT brend = '' ORDER BY brend ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT brend = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch1_2 ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch1_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch1_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch3_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch3_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch3_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch4_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch4_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch4_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch5_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch5_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch5_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch6_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch6_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch6_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch7_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch7_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch7_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch8_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch8_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch8_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch9_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch9_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch9_2 ASC");
...
?>       
  ...
  <div class="closeModalSearrchBss_lin_ide"></div>
   <!--<button style="width: 28px;" class="LoadFilter11ClosegridcontainerOpen LoadFilter11"><img class="closeImgFill" src="img/imgSite/closeFill.png"></button>-->
   <h4><?php echo $rowch101echo; ?></h4>

<?php

  $result = mysqli_query($link, "SELECT DISTINCT(ch10_2) FROM redresorinitial INNER JOIN redresorkrosstablefilter ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator WHERE NOT ch10_2 = '' AND categoryinfilter = 'Redresor alternator' ORDER BY ch10_2 ASC");
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    do{
      ...
      if ($_GET["ch10_2"]) {
        ...
        $stickerfilter = '<div class="fruit10 stickerfiltercss"></div>';
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    do{  
      ...
      if ($_GET["ch10_2"]) {
        ...
        if (in_array($row["ch10_2"], $_GET["ch10_2"])){
          $checked_button = 'checked';
          $getdata = $_GET["ch10_2"];
        }
    ...
    '<div class="box">
      <div class="item">
       <div class="checkbox-circle">
        <input '.$checked_button.' type="checkbox" class="common_selector ch10_2" value="'.$row['ch10_2'].'" id="checkbox-circle'.$row['ch10_2'].'ch10_2" name="ch10_2[]">
        <label for="checkbox-circle'.$row['ch10_2'].'ch10_2">'.$row['ch10_2'].'</label>
       </div>
      </div>
     </div>';
...
<div class="CatalogGrid2">
 <div class="contentCatalog">
  <div id="myULssh" class="row filter_data" >
    ...
    $count = mysqli_query($link, "SELECT redresorinitial.id, redresorinitial.link, redresorinitial.brend, redresorinitial.title, redresorinitial.imgsrc, redresorinitial.price, redresorinitial.category, redresorinitial.product_status, redresorinitial.voltag, redresorkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, redresorkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, redresorkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, redresorkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, redresorkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, redresorkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, redresorkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, redresorkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, redresorkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, redresorkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, redresorkrosstablefilter.ch10_2 FROM redresorinitial
    LEFT JOIN redresorkrosstablefilter
    ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON redresorkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
  ...
  $result = mysqli_query($link, "SELECT redresorinitial.id, redresorinitial.link, redresorinitial.brend, redresorinitial.title, redresorinitial.imgsrc, redresorinitial.price, redresorinitial.category, redresorinitial.product_status, redresorinitial.voltag, redresorkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, redresorkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, redresorkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, redresorkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, redresorkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, redresorkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, redresorkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, redresorkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, redresorkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, redresorkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, redresorkrosstablefilter.ch10_2 FROM redresorinitial
    LEFT JOIN redresorkrosstablefilter
    ON redresorinitial.voltag = redresorkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON redresorkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
    WHERE product_status = '1' $query_ch1_2 $query_ch1_3 $query_ch1_4 $query_ch1_5 $query_ch1_6 $query_ch1_7 $query_ch1_8 $query_ch1_9 $query_ch1_10 $query_ch1_11 $query_ch1_12 ORDER BY id DESC $query_start_num");
 ...
 $result1 = mysqli_query($link, "SELECT SUM(Column_4) AS Column_5sum FROM `redresorstock` WHERE `Column_3` = '$titleupakovka' AND (`Column_2` = '$linksklad5' OR `Column_1` = '$linksklad5')");
