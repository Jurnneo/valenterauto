...
<title>Stator alternator în Iași, Romania.</title>
...
<div class="footerrtyInside11erCatalog">
  ...
  <a href="#"><p><img src="/img/imgSite/catalogButton1.png" class="footerrtyInside11erCatalogImg">STATOR ALTERNATOR</p></a>               
</div>

<div class="whyNotWork">
 <h2 class="catTest">STATOR ALTERNATOR <span style="display: none;">1.681 POZIȚII</span></h2>
...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  $result = mysqli_query($link, "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Stator alternator'");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM statoraltinitial ORDER BY brend ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM statoraltinitial WHERE NOT brend = '' ORDER BY brend ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT brend = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch1_2 ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT ch1_2 = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch1_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch2_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT ch2_2 = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch2_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch3_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT ch3_2 = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch3_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch4_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT ch4_2 = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch4_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch5_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT ch5_2 = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch5_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch6_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT ch6_2 = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch6_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch7_2) FROM statoraltinitial INNER JOIN statoraltkrosstablefilter ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator WHERE NOT ch7_2 = '' AND categoryinfilter = 'Stator alternator' ORDER BY ch7_2 ASC");
...
<div class="CatalogGrid2">
 <div class="contentCatalog">
  <div id="myULssh" class="row filter_data" >
    ...
    $count = mysqli_query($link, "SELECT statoraltinitial.id, statoraltinitial.link, statoraltinitial.brend, statoraltinitial.title, statoraltinitial.imgsrc, statoraltinitial.price, statoraltinitial.category, statoraltinitial.product_status, statoraltinitial.voltag, statoraltkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, statoraltkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, statoraltkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, statoraltkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, statoraltkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, statoraltkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, statoraltkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, statoraltkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, statoraltkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, statoraltkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, statoraltkrosstablefilter.ch10_2 FROM statoraltinitial
    LEFT JOIN statoraltkrosstablefilter
    ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON statoraltkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
  ...
  $result = mysqli_query($link, "SELECT statoraltinitial.id, statoraltinitial.link, statoraltinitial.brend, statoraltinitial.title, statoraltinitial.imgsrc, statoraltinitial.price, statoraltinitial.category, statoraltinitial.product_status, statoraltinitial.voltag, statoraltkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, statoraltkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, statoraltkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, statoraltkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, statoraltkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, statoraltkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, statoraltkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, statoraltkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, statoraltkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, statoraltkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, statoraltkrosstablefilter.ch10_2 FROM statoraltinitial
    LEFT JOIN statoraltkrosstablefilter
    ON statoraltinitial.voltag = statoraltkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON statoraltkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
    WHERE product_status = '1' $query_ch1_2 $query_ch1_3 $query_ch1_4 $query_ch1_5 $query_ch1_6 $query_ch1_7 $query_ch1_8 $query_ch1_9 $query_ch1_10 $query_ch1_11 $query_ch1_12 ORDER BY id DESC $query_start_num");
 ...
 $result1 = mysqli_query($link, "SELECT SUM(Column_4) AS Column_5sum FROM `statoraltstock` WHERE `Column_3` = '$titleupakovka' AND (`Column_2` = '$linksklad5' OR `Column_1` = '$linksklad5')");
