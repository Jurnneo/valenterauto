...
<title>Fulie cu ambreiaj în Iași, Romania.</title>
...
<div class="footerrtyInside11erCatalog">
  ...
  <a href="#"><p><img src="/img/imgSite/catalogButton1.png" class="footerrtyInside11erCatalogImg">FULIE CU AMBREIAJ</p></a>               
</div>

<div class="whyNotWork">
 <h2 class="catTest">FULIE CU AMBREIAJ <span style="display: none;">1.681 POZIȚII</span></h2>
...
<div class="CatalogGrid">
 <div class="CatalogGridBackDiv111 CatalogGridBackDiv">
  ...
  $result = mysqli_query($link, "SELECT ch1_1, ch2_1, ch3_1, ch4_1, ch5_1, ch6_1, ch7_1, ch8_1, ch9_1, ch10_1 FROM krosstablefilter_categories WHERE categoryinfilter1 = 'Fulie cu ambreiaj'");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM fuliecuambrenajinitial ORDER BY brend ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT brend FROM fuliecuambrenajinitial WHERE NOT brend = '' ORDER BY brend ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT brend = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch1_2 ASC");
...
?>
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch1_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch1_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch1_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch2_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch2_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch2_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch3_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch3_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch3_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch4_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch4_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch4_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch5_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch5_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch5_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch6_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch6_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch6_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch7_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch7_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch7_2 ASC");
...
<?php
  ...
  $result = mysqli_query($link, "SELECT DISTINCT(ch8_2) FROM fuliecuambrenajinitial INNER JOIN fuliecuambrenajkrosstablefilter ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator WHERE NOT ch8_2 = '' AND categoryinfilter = 'Fulie cu ambreiaj' ORDER BY ch8_2 ASC");
...
<div class="CatalogGrid2">
 <div class="contentCatalog">
  <div id="myULssh" class="row filter_data" >
    ...
    $count = mysqli_query($link, "SELECT fuliecuambrenajinitial.id, fuliecuambrenajinitial.link, fuliecuambrenajinitial.brend, fuliecuambrenajinitial.title, fuliecuambrenajinitial.imgsrc, fuliecuambrenajinitial.price, fuliecuambrenajinitial.category, fuliecuambrenajinitial.product_status, fuliecuambrenajinitial.voltag, fuliecuambrenajkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, fuliecuambrenajkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, fuliecuambrenajkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, fuliecuambrenajkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, fuliecuambrenajkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, fuliecuambrenajkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, fuliecuambrenajkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, fuliecuambrenajkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, fuliecuambrenajkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, fuliecuambrenajkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, fuliecuambrenajkrosstablefilter.ch10_2 FROM fuliecuambrenajinitial
    LEFT JOIN fuliecuambrenajkrosstablefilter
    ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON fuliecuambrenajkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
  ...
  $result = mysqli_query($link, "SELECT fuliecuambrenajinitial.id, fuliecuambrenajinitial.link, fuliecuambrenajinitial.brend, fuliecuambrenajinitial.title, fuliecuambrenajinitial.imgsrc, fuliecuambrenajinitial.price, fuliecuambrenajinitial.category, fuliecuambrenajinitial.product_status, fuliecuambrenajinitial.voltag, fuliecuambrenajkrosstablefilter.linkalternator, krosstablefilter_categories.ch1, fuliecuambrenajkrosstablefilter.ch1_2, krosstablefilter_categories.ch2, fuliecuambrenajkrosstablefilter.ch2_2, krosstablefilter_categories.ch3, fuliecuambrenajkrosstablefilter.ch3_2, krosstablefilter_categories.ch4, fuliecuambrenajkrosstablefilter.ch4_2, krosstablefilter_categories.ch5, fuliecuambrenajkrosstablefilter.ch5_2, krosstablefilter_categories.ch6, fuliecuambrenajkrosstablefilter.ch6_2, krosstablefilter_categories.ch7, fuliecuambrenajkrosstablefilter.ch7_2, krosstablefilter_categories.ch8, fuliecuambrenajkrosstablefilter.ch8_2, krosstablefilter_categories.ch9, fuliecuambrenajkrosstablefilter.ch9_2, krosstablefilter_categories.ch10, fuliecuambrenajkrosstablefilter.ch10_2 FROM fuliecuambrenajinitial
    LEFT JOIN fuliecuambrenajkrosstablefilter
    ON fuliecuambrenajinitial.voltag = fuliecuambrenajkrosstablefilter.linkalternator LEFT JOIN krosstablefilter_categories ON fuliecuambrenajkrosstablefilter.categoryinfilter = krosstablefilter_categories.categoryinfilter1
    WHERE product_status = '1' $query_ch1_2 $query_ch1_3 $query_ch1_4 $query_ch1_5 $query_ch1_6 $query_ch1_7 $query_ch1_8 $query_ch1_9 $query_ch1_10 $query_ch1_11 $query_ch1_12 ORDER BY id DESC $query_start_num");
 ...
 $result1 = mysqli_query($link, "SELECT SUM(Column_4) AS Column_5sum FROM `fuliestock` WHERE `Column_3` = '$titleupakovka' AND (`Column_2` = '$linksklad5' OR `Column_1` = '$linksklad5')");
