...
$query .= " LIMIT " . $_POST["limit"] . " OFFSET " . $_POST["offset"];
 ...
 if($total_row > 0)
 {
  ...
  {
   $output .= '
   <div data-tilt data-tilt-scale="1.03" data-tilt-glare data-tilt-max-glare="0.5" data-tilt-max="10" data-tilt-speed="4000 " style="background-image: url(img/backpost.png);" class="contentPost '. $row['naznacenie'] .'">
    <a href="article.php?id='. $row['id'] .'" target="_blank" >
     <div style="background-image: url(img/imgArt/small/'. $row['imgInterier'] .'");" class="contentPostImg">
