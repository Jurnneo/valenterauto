...
<div class="wow fadeIn searchGallDivv galleryDiv mobileGallDivv">
    ...
    $query = "SELECT electromotorinitial.id, electromotorinitial.imgsrc, electromotorinitial.link, electromotorinitial.autovalenter, electromotorinitial.psh, electromotorinitial.wood, electromotorinitial.waiglobal, electromotorinitial.category, electromotorinitial.voltag, electromotorkrosstablefilter.ch1_2, electromotorkrosstablefilter.ch2_2, electromotorkrosstablefilter.ch3_2, electromotorkrosstablefilter.ch4_2, electromotorkrosstablefilter.ch5_2, electromotorkrosstablefilter.ch6_2, electromotorkrosstablefilter.ch1, electromotorkrosstablefilter.ch2, electromotorkrosstablefilter.ch3, electromotorkrosstablefilter.ch4, electromotorkrosstablefilter.ch5, electromotorkrosstablefilter.ch6, electromotorkrosstable.linkalternator, electromotorkrosstable.mitsubishi, electromotorkrosstable.bosch, electromotorkrosstable.delco, electromotorkrosstable.renault, electromotorkrosstable.mercedesbenz, electromotorkrosstable.ford, electromotorkrosstable.valeo, electromotorkrosstable.ass1, electromotorkrosstable.cas, electromotorkrosstable.hyundai, electromotorkrosstable.cargo, electromotorkrosstable.kia, electromotorkrosstable.krauf, electromotorkrosstable.mando, electromotorkrosstable.messmer, electromotorkrosstable.motorherz, electromotorkrosstable.zaufer, electromotorkrosstable.wai, electromotorkrosstable.hc_parts, electromotorkrosstable.hella, electromotorkrosstable.lucas, electromotorkrosstable.magnetimarelli, electromotorkrosstable.wps, electromotorkrosstable.bcc, electromotorkrosstable.prestolite, electromotorkrosstable.volvo, electromotorkrosstable.yam, electromotorkrosstable.hbb, electromotorkrosstable.mazda, electromotorkrosstable.daewoo, electromotorkrosstable.gmm, electromotorkrosstable.maz, electromotorkrosstable.pmx, electromotorkrosstable.unipoint, electromotorkrosstable.citroen, electromotorkrosstable.nissan, electromotorkrosstable.reparts, electromotorkrosstable.bll, electromotorkrosstable.acdelco, electromotorkrosstable.generalmotors, electromotorkrosstable.brillance, electromotorkrosstable.komatsu, electromotorkrosstable.nikko, electromotorkrosstable.wll, electromotorkrosstable.vag, electromotorkrosstable.hino, electromotorkrosstable.sawafuji, electromotorkrosstable.poong_sung, electromotorkrosstable.motorola, electromotorkrosstable.cat, electromotorkrosstable.hyster, electromotorkrosstable.skk, electromotorkrosstable.pee, electromotorkrosstable.magneton, electromotorkrosstable.case, electromotorkrosstable.deutz, electromotorkrosstable.mahle, electromotorkrosstable.khd, electromotorkrosstable.iskra, electromotorkrosstable.hitachi, electromotorkrosstable.john_deere, electromotorkrosstable.vww, electromotorkrosstable.denso, electromotorkrosstable.general_motors, electromotorkrosstable.opel FROM `electromotorinitial` INNER JOIN `electromotorkrosstable` ON electromotorinitial.voltag = electromotorkrosstable.linkalternator INNER JOIN `electromotorkrosstablefilter` ON electromotorkrosstablefilter.linkalternator = electromotorkrosstable.linkalternator WHERE product_status = '1' AND (electromotorkrosstable.linkalternator LIKE '%".$search."%'    
      OR electromotorinitial.autovalenter LIKE '%".$search."%'
      OR electromotorinitial.link LIKE '%".$search."%'
      OR electromotorinitial.psh LIKE '%".$search."%'
      OR electromotorinitial.wood LIKE '%".$search."%'
      OR electromotorinitial.waiglobal LIKE '%".$search."%'
      OR electromotorkrosstable.bosch LIKE '%".$search."%'
      OR electromotorkrosstable.mitsubishi LIKE '%".$search."%'
      OR electromotorkrosstable.delco LIKE '%".$search."%'
      OR electromotorkrosstable.renault LIKE '%".$search."%'
      OR electromotorkrosstable.mercedesbenz LIKE '%".$search."%'
      OR electromotorkrosstable.ford LIKE '%".$search."%'
      OR electromotorkrosstable.valeo LIKE '%".$search."%'
      OR electromotorkrosstable.ass1 LIKE '%".$search."%'
      OR electromotorkrosstable.cas LIKE '%".$search."%'
      OR electromotorkrosstable.hyundai LIKE '%".$search."%'
      OR electromotorkrosstable.kia LIKE '%".$search."%'
      OR electromotorkrosstable.krauf LIKE '%".$search."%'
      OR electromotorkrosstable.mando LIKE '%".$search."%'
      OR electromotorkrosstable.messmer LIKE '%".$search."%'
      OR electromotorkrosstable.motorherz LIKE '%".$search."%'
      OR electromotorkrosstable.zaufer LIKE '%".$search."%'
      OR electromotorkrosstable.wai LIKE '%".$search."%'
      OR electromotorkrosstable.hc_parts LIKE '%".$search."%'
      OR electromotorkrosstable.hella LIKE '%".$search."%'
      OR electromotorkrosstable.lucas LIKE '%".$search."%'
      OR electromotorkrosstable.magnetimarelli LIKE '%".$search."%'
      OR electromotorkrosstable.wps LIKE '%".$search."%'
      OR electromotorkrosstable.bcc LIKE '%".$search."%'
      OR electromotorkrosstable.prestolite LIKE '%".$search."%'
      OR electromotorkrosstable.volvo LIKE '%".$search."%'
      OR electromotorkrosstable.yam LIKE '%".$search."%'
      OR electromotorkrosstable.hbb LIKE '%".$search."%'
      OR electromotorkrosstable.mazda LIKE '%".$search."%'
      OR electromotorkrosstable.daewoo LIKE '%".$search."%'
      OR electromotorkrosstable.gmm LIKE '%".$search."%'
      OR electromotorkrosstable.maz LIKE '%".$search."%'
      OR electromotorkrosstable.pmx LIKE '%".$search."%'
      OR electromotorkrosstable.unipoint LIKE '%".$search."%'
      OR electromotorkrosstable.citroen LIKE '%".$search."%'
      OR electromotorkrosstable.reparts LIKE '%".$search."%'
      OR electromotorkrosstable.bll LIKE '%".$search."%'
      OR electromotorkrosstable.acdelco LIKE '%".$search."%'
      OR electromotorkrosstable.generalmotors LIKE '%".$search."%'
      OR electromotorkrosstable.brillance LIKE '%".$search."%'
      OR electromotorkrosstable.komatsu LIKE '%".$search."%'
      OR electromotorkrosstable.nikko LIKE '%".$search."%'
      OR electromotorkrosstable.wll LIKE '%".$search."%'
      OR electromotorkrosstable.vag LIKE '%".$search."%'
      OR electromotorkrosstable.hino LIKE '%".$search."%'
      OR electromotorkrosstable.sawafuji LIKE '%".$search."%'
      OR electromotorkrosstable.poong_sung LIKE '%".$search."%'
      OR electromotorkrosstable.motorola LIKE '%".$search."%'
      OR electromotorkrosstable.cat LIKE '%".$search."%'
      OR electromotorkrosstable.hyster LIKE '%".$search."%'
      OR electromotorkrosstable.skk LIKE '%".$search."%'
      OR electromotorkrosstable.pee LIKE '%".$search."%'
      OR electromotorkrosstable.magneton LIKE '%".$search."%'
      OR electromotorkrosstable.case LIKE '%".$search."%'
      OR electromotorkrosstable.deutz LIKE '%".$search."%'
      OR electromotorkrosstable.mahle LIKE '%".$search."%'
      OR electromotorkrosstable.khd LIKE '%".$search."%'
      OR electromotorkrosstable.iskra LIKE '%".$search."%'
      OR electromotorkrosstable.hitachi LIKE '%".$search."%'
      OR electromotorkrosstable.john_deere LIKE '%".$search."%'
      OR electromotorkrosstable.vww LIKE '%".$search."%'
      OR electromotorkrosstable.denso LIKE '%".$search."%'
      OR electromotorkrosstable.general_motors LIKE '%".$search."%'
      OR electromotorkrosstable.opel LIKE '%".$search."%'
      OR electromotorkrosstable.nissan LIKE '%".$search."%'
      OR electromotorkrosstable.cargo LIKE '%".$search."%')
      ORDER BY id DESC";
